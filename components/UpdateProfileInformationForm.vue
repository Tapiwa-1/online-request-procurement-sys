    ...
    <section>
        ...
        <div class="mt-6 space-y-6">
            <div>
                ...
                <TextInput id="name" type="text" class="mt-1 block w-full" placeholder="This is place holder"
            ...
            <div>
                ...
                <TextInput id="email" type="email" class="mt-1 block w-full" placeholder="This is place holder"
