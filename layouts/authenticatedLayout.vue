<template>
    <div v-if="false" class="p-4 text-sm text-green-700 bg-green-100  dark:bg-gray-800 dark:text-green-400" role="alert">
                ...
                <Menu as="div" class="relative ml-3">
                    ...
                    <transition enter-active-class="transition ease-out duration-100"
                        ...
                        <MenuItems
                            ...
                            <NuxtLink :role="item.role" :href="item.href"
                                :class="[active ? 'bg-gray-100 dark:bg-gray-900 ' : '', 'block px-4 py-2 text-sm text-gray-700 dark:text-white']">
                                {{ item.name }}</NuxtLink>
                            </MenuItem>
                            <NuxtLink as="button"
    ...
    <div v-if="display"
        ...
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1 flex items-center">
                <h1 class="font-bold text-gray-800 dark:text-gray-200 text-[15px] ml-3">e-Tengai</h1>
...
const userNavigation = [
    { name: 'Dashboard', href: '/admin/dashboard', role: '' },
